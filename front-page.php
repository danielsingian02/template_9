...
<body>
    <div class="banner" style="background-image:url('<?php echo get_theme_mod('banner_image',get_bloginfo('template_directory').'/assets/images/Template 9 1.png' ); ?>')">
       ...
       <h1> <?php printf( get_theme_mod('banner_heading', __( 'ABC', 'banner_heading' ) )); ?></h1>
            <h2><?php printf( get_theme_mod('banner_subheading', __( 'Homeowners association', 'banner_subheading' ) )); ?></h2>
    ...
    <div class="text-heading">
        ...
        <img id="small-diamond" src="<?php echo get_theme_mod('diamond_image',get_bloginfo('template_directory').'/assets/images/Screenshot_2.png' )?>" border="0" alt="">
    ...
    <div class="text-heading-2">
        ...
        <img id="small-diamond" src="<?php echo get_theme_mod('diamond_image2',get_bloginfo('template_directory').'/assets/images/Screenshot_2.png' )?>" border="0" alt="">
